...
const SUGGESTED_QUESTIONS = [
  "Каков мой баланс по всем счетам?",
  "Какие расходы были в этом месяце?",
  "Какая статья расходов самая крупная?",
  "Сравни доходы этого и прошлого месяца",
];
    ...
    <Card className="h-full border-0 shadow-sm flex flex-col overflow-hidden">
        ...
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center px-4">
            ...
            <p className="text-sm text-gray-500 mb-6 max-w-sm">
              Я анализирую данные вашей компании и отвечаю на вопросы о финансах,
              транзакциях и отчётах.
            </p>
      ...
      <div className="p-4 border-t border-gray-100">
        ...
        <p className="text-xs text-gray-400 mt-2 text-center">
          Ответы основаны на данных вашей компании
        </p>
      </div>
    </Card>
  );
